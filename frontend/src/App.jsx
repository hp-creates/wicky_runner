    ...
    <div className="wiki-shell">
      ...
      <header className="wiki-header">
        <div className="wiki-header-left">
          ...
          <div className="wiki-brand" onClick={() => handleRunSpeedrun('Apple', 'Steve Jobs')}>
            ...
            <div className="wiki-brand-text">
              <span className="wiki-brand-title">Wicky Runner</span>
        ...
        <div className="wiki-header-right">
          <a
            href="https://github.com/hp-creates/wicky_runner"
            target="_blank"
            rel="noopener noreferrer"
            className="wiki-btn-secondary wiki-header-btn"
            title="View Source on GitHub (hp-creates/wicky_runner)"
          ...
          >
            ...
            <span className="wiki-btn-text">GitHub</span>
          </a>

          <button
            onClick={() => setShowLLMSettings(!showLLMSettings)}
            className={`wiki-btn-secondary wiki-header-btn ${enableLLM ? 'active' : ''}`}
            title="Configure Gemini LLM Guidance"
          >
            <Cpu size={14} style={{ flexShrink: 0 }} />
            <span className="wiki-btn-text">{enableLLM ? 'AI Advisor On' : 'AI Advisor'}</span>
            <span className="wiki-btn-text-mobile">{enableLLM ? 'AI On' : 'AI'}</span>
          </button>
        </div>
      </header>
      ...
      <div className="wiki-container">
        ...
        <main className="wiki-content">
          {/* Dedicated Route Search Panel (Separated from Navbar) */}
          <div className="wiki-route-search-panel">
            <div className="wiki-search-box">
              ...
              <input
                ...
                placeholder="Search start page (e.g. Apple)..."
            ...
            <div className="wiki-search-box">
              ...
              <input
                ...
                placeholder="Search target page (e.g. Steve Jobs)..."
                className="wiki-search-input"
                disabled={traversing}
                onKeyDown={e => e.key === 'Enter' && handleRunSpeedrun()}
              />
            ...
            <div className="wiki-search-actions">
              <button
                ...
                className="wiki-btn-primary wiki-speedrun-btn"
                disabled={traversing}
              >
                <Search size={14} />
              ...
              <button
                ...
                className="wiki-btn-secondary wiki-random-btn"
          ...
          <div className="wiki-article-body">
            ...
            <div className="wiki-main-column">
              ...
              <div id="route-narrative">
                ...
                <div className="wiki-table-responsive">
